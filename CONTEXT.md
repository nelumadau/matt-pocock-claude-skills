...
A collection of agent skills (workflows and behaviors) intended to be used in Cursor. Skills are organized into buckets and consumed by per-repo configuration emitted by `setup-matt-pocock-skills`.
